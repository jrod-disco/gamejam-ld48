...
export const BEGIN_LANDING_DEPTH = 4750; // feet
...
export const MAX_LAYER_DEPTH = 16; // layers of sprite depth (was 32)
// TODO: Make Layer Spacing a function of layer depth
export const LAYER_SPACING = 0.15; // start distance between each layer (was 0.075)
...
export const SPEED_CAVE = 0.005; // cave scale increase per update()
...
export const PLAYER_DESCENT_RATE = 0.5; // feet per update  (0.5 yields a 2m game)
...
export const PLAYER_COLLISION_VALUE = 6; // damage from wall collision (x movement speed)
